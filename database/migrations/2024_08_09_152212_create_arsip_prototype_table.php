...
return new class extends Migration
{
    ...
    {
        Schema::create('arsip_prototype', function (Blueprint $table) {
            $table->integer('id_arsip_prototype')->autoIncrement()->unsigned();
            ...
            $table->string('file_arsip_prototype')->nullable();
            $table->string('cover_arsip_prototype')->nullable();
            $table->string('created_by')->nullable();
            $table->timestamps();
        });

        Schema::table('arsip_prototype', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('arsip_prototype');
    }
};
