...
function geojson(json, hType = 'map', series) {
    ...
    geojson.features.forEach(function (feature) {
        const geometry = feature.geometry || {}, type = geometry.type, coordinates = geometry.coordinates,
        ...
        if (pointOptions) {
            const name = properties && (properties.name || properties.NAME), lon = properties && properties.lon,
