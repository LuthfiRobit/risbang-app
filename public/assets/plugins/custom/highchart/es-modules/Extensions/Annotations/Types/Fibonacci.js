...
function createPathDGenerator(retracementIndex, isBackground) {
    return function () {
        ...
        const leftTop = this.anchor(annotation.startRetracements[retracementIndex]).absolutePosition,
...
class Fibonacci extends Tunnel {
    ...
    linkRetracementsPoints() {
        const points = this.points, startDiff = points[0].y - points[3].y, endDiff = points[1].y - points[2].y,
