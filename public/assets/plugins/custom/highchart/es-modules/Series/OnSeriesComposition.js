...
(function (OnSeriesComposition) {
    ...
    function translate() {
        ...
        const series = this, options = series.options, chart = series.chart, points = series.points,
            ...
            yAxis = series.yAxis;
        let cursor = points.length - 1, point, lastPoint, onKey = options.onKey || 'y', i = onData && onData.length,
