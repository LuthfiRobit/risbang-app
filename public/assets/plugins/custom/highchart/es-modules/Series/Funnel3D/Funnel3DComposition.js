    ...
    function wrapElement3D(elements3d) {
        elements3d.funnel3d = merge(elements3d.cuboid, {
            ...
            opacitySetter: function (opacity) {
                const funnel3d = this, parts = funnel3d.parts, chart = H.charts[funnel3d.renderer.chartIndex],
            ...
            fillSetter: function (fill) {
                ...
                if (fillColor.linearGradient) {
                    ...
                    funnel3d.sideGroups.forEach(function (sideGroupName) {
                        const box = funnel3d[sideGroupName].gradientBox, gradient = fillColor.linearGradient,
                    ...
                    if (fillColor.radialGradient) {
                        funnel3d.sideGroups.forEach(function (sideGroupName) {
                            const gradBox = funnel3d[sideGroupName].gradientBox,
                                centerX = gradBox.x + gradBox.width / 2, centerY = gradBox.y + gradBox.height / 2,
    ...
    function wrapRenderer3D(SVGRendererClass) {
        ...
        extend(rendererProto, {
            funnel3d: function (shapeArgs) {
                const renderer = this, funnel3d = renderer.element3d('funnel3d', shapeArgs),
