...
(function (SeriesOnPointComposition) {
    ...
    class Additions {
        ...
        getConnectorAttributes() {
            ...
            const connectorOpts = onPointOptions.connectorOptions || {}, position = onPointOptions.position,
            ...
            const xFrom = defined(position.x) ?
                    ...
                    position.y :
                    connectedPoint.plotY, xTo = xFrom + (position.offsetX || 0), yTo = yFrom + (position.offsetY || 0),
                width = connectorOpts.width || 1, color = connectorOpts.stroke || this.series.color,
                dashStyle = connectorOpts.dashstyle, attribs = {
