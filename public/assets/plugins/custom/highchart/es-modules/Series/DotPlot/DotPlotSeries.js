...
class DotPlotSeries extends ColumnSeries {
     ...
     * */
    drawPoints() {
        const series = this, renderer = series.chart.renderer, seriesMarkerOptions = this.options.marker,
        ...
        this.points.forEach(function (point) {
            let yPos, attr, graphics, pointAttr, pointMarkerOptions = point.marker || {},
