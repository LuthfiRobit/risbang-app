...
class VariablePieSeries extends PieSeries {
     ...
     */
    calculateExtremes() {
        let series = this, chart = series.chart, plotWidth = chart.plotWidth, plotHeight = chart.plotHeight,
    ...
    getRadii(zMin, zMax, minSize, maxSize) {
        let i = 0, pos, zData = this.zData, len = zData.length, radii = [], options = this.options,
