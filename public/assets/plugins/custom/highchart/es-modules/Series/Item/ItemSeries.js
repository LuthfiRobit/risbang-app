...
class ItemSeries extends PieSeries {
    ...
    drawPoints() {
        let series = this, options = this.options, renderer = series.chart.renderer,
        ...
        //*/
        this.points.forEach(function (point) {
            let attr, graphics, pointAttr, pointMarkerOptions = point.marker || {},
     ...
     */
    getSlots() {
        let center = this.center, diameter = center[2], innerSize = center[3], row, slots = this.slots, x, y, rowRadius,
