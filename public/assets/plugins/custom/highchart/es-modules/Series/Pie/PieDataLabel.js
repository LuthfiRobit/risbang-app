...
(function (ColumnDataLabel) {
    ...
    function drawDataLabels() {
        const series = this, data = series.data, chart = series.chart, options = series.options.dataLabels || {},
    ...
    function verifyDataLabelOverflow(overflow) {
        let center = this.center, options = this.options, centerOption = options.center,
