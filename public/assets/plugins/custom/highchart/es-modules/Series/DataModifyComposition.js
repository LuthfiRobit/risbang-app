...
(function (DataModifyComposition) {
    ...
    function afterProcessData() {
        ...
        if (series.xAxis && // not pies
            ...
            series.dataModify) {
            const processedXData = series.processedXData, processedYData = series.processedYData,
                length = processedYData.length, compareStart = series.options.compareStart === true ? 0 : 1;
            let keyIndex = -1, i;
