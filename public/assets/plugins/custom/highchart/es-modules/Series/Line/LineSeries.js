...
class LineSeries extends Series {
     ...
     */
    drawGraph() {
        const series = this, options = this.options, graphPath = (this.gappedPath || this.getGraphPath).call(this),
    ...
    getGraphPath(points, nullsAsZeroes, connectCliffs) {
        ...
        points.forEach(function (point, i) {
            const plotX = point.plotX, plotY = point.plotY, lastPoint = points[i - 1],
