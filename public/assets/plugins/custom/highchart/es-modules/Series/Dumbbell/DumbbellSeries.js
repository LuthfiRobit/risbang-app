...
class DumbbellSeries extends AreaRangeSeries {
    ...
    getConnectorAttribs(point) {
        let series = this, chart = series.chart, pointOptions = point.options, seriesOptions = series.options,
     ...
     */
    drawConnector(point) {
        const series = this, animationLimit = pick(series.options.animationLimit, 250),
     ...
     */
    drawPoints() {
        let series = this, chart = series.chart, pointLength = series.points.length,
