...
class TimelinePoint extends Series.prototype.pointClass {
    ...
    alignConnector() {
        let point = this, series = point.series, connector = point.connector, dl = point.dataLabel,
    ...
    getConnectorPath() {
        let point = this, chart = point.series.chart, xAxisLen = point.series.xAxis.len, inverted = chart.inverted,
