...
class BoxPlotSeries extends ColumnSeries {
     ...
     */
    drawPoints() {
        let series = this, points = series.points, options = series.options, chart = series.chart,
        ...
        points.forEach(function (point) {
            let graphic = point.graphic, verb = graphic ? 'animate' : 'attr', shapeArgs = point.shapeArgs, boxAttr = {},
