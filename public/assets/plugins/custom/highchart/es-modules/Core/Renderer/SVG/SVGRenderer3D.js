...
class SVGRenderer3D extends SVGRenderer {
    ...
    /** @private */
    arc3d(attribs) {
        const wrapper = this.g(), renderer = wrapper.renderer,
        ...
        wrapper.animate = function (params, animation, complete) {
            let paramArr, from = this.attribs, to, anim,
    ...
    arc3dPath(shapeArgs) {
        ...
        // and beta rotations
        let angleCorr = Math.atan2(dy, -dx), angleEnd = Math.abs(end + angleCorr),
        ...
        const incPrecision = 1e5, a1 = angleMid * incPrecision, a2 = angleStart * incPrecision,
