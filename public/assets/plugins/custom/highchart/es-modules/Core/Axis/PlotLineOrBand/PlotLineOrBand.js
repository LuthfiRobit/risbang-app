...
class PlotLineOrBand {
    ...
    render() {
        ...
        const plotLine = this, axis = plotLine.axis, horiz = axis.horiz, log = axis.logarithmic,
        ...
        let optionsLabel = options.label, label = plotLine.label, to = options.to, from = options.from,
