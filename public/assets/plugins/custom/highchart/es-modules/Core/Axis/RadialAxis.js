...
(function (RadialAxis) {
    ...
    function getPlotBandPath(from, to, options) {
        ...
        let start, end, angle, xOnPerimeter, open, path,
    ...
    function onAxisAfterInit() {
        const chart = this.chart, options = this.options, isHidden = chart.angular && this.isXAxis, pane = this.pane,
    ...
    function onAxisInit(e) {
        const chart = this.chart, inverted = chart.inverted, angular = chart.angular, polar = chart.polar,
    ...
    function onTickAfterGetLabelPosition(e) {
        ...
        const axis = this.axis, labelBBox = label.getBBox(), labelOptions = axis.options.labels,
