...
function format(str = '', ctx, chart) {
    const regex = /\{([a-zA-Z0-9:.,;\-\/<>%_@"'= #()]+)}/g,
        ...
        subRegex = /\(([a-zA-Z0-9:.,;\-\/<>%_@"'= ]+)\)/g, matches = [], floatRegex = /f$/, decRegex = /\.([0-9])/,
        lang = defaultOptions.lang, time = chart && chart.time || defaultTime,
...
function numberFormat(number, decimals, decimalPoint, thousandsSep) {
    ...
    const lang = defaultOptions.lang, origDec = (number.toString().split('.')[1] || '').split('e')[0].length,
