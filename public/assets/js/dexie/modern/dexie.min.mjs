...
function l(e, t, n, s) {
    u(e, t, r(n && o(n, "get") && "function" == typeof n.get ? {get: n.get, set: n.set, configurable: !0} : {
        value: n,
        configurable: !0,
        writable: !0
    }, s))
...
function c(e) {
    return {
        from: function (t) {
            return e.prototype = Object.create(t.prototype), l(e.prototype, "constructor", e), {extend: a.bind(null, e.prototype)}
        }
    }
}
...
var ve = !1, ge = fe ? () => {
    ...
    id: "global", global: !0, ref: 0, unhandleds: [], onunhandled: dt, pgp: !1, env: {}, finalize: function () {
...
function Te(e, t) {
    if (ke.push(t), null === e._state) {
        ...
        t = Pe(t), e._state = !1, e._value = t, R && null !== t && "object" == typeof t && !t._promise && function (e, t, n) {
            ...
            var n = d(t, "stack");
            t._promise = e, l(t, "stack", {get: () => ve ? n && (n.get ? n.get.apply(t) : n.value) : e.stack})
        })), function (e) {
...
a(je.prototype, {
    ...
    return new je((t => {
        ...
        e.forEach(((e, s) => je.resolve(e).then((e => r[s] = {
            status: "fulfilled",
            value: e
        }), (e => r[s] = {status: "rejected", reason: e})).then((() => --n || t(r)))))
    }))
...
function dt(t, n) {
    ...
    if (!1 !== s) try {
        var i, o = {promise: n, reason: t};
        if (e.document && document.createEvent ? ((i = document.createEvent("Event")).initEvent(ht, !0, !0), r(i, o)) : e.CustomEvent && r(i = new CustomEvent(ht, {detail: o}), o), i && e.dispatchEvent && (dispatchEvent(i), !e.PromiseRejectionEvent && e.onunhandledrejection)) try {
...
const yt = "3.2.4", mt = String.fromCharCode(65535), vt = -1 / 0,
    gt = "Invalid key provided. Keys must be of type string, number, Date or Array<string | number | Date>.",
    bt = "String expected.", _t = [],
    wt = "undefined" != typeof navigator && /(MSIE|Trident|Edge)/.test(navigator.userAgent), xt = wt, kt = wt,
    Et = e => !/(dexie\.js|dexie\.min\.js)/.test(e), Pt = "__dbnames", Kt = "readonly", Ot = "readwrite";
...
class jt {
    ...
    bulkAdd(e, t, n) {
        ...
        return this._trans("readwrite", (t => {
            ...
            return this.core.mutate({trans: t, type: "add", keys: r, values: a, wantResults: s}).then((({
                                                                                                            numFailures: e,
                                                                                                            results: t,
                                                                                                            lastResult: n,
                                                                                                            failures: r
    ...
    bulkPut(e, t, n) {
        ...
        return this._trans("readwrite", (t => {
            ...
            const o = e.length;
            let a = i && n ? e.map(Ct(i)) : e;
            return this.core.mutate({trans: t, type: "put", keys: r, values: a, wantResults: s}).then((({
                                                                                                            numFailures: e,
                                                                                                            results: t,
                                                                                                            lastResult: n,
                                                                                                            failures: r
...
class Vt {
    ...
    count(e) {
        return this._read((e => {
            ...
            if (Bt(t, !0)) return n.count({
                trans: e,
                query: {index: Ft(t, n.schema), range: t.range}
    ...
    modify(e) {
        ...
        return this._write((r => {
            ...
            const a = n.table.core, {outbound: u, extractKey: l} = a.schema.primaryKey,
                c = this.db._options.modifyChunkSize || 200, h = [];
            let d = 0;
            const f = [], p = (e, n) => {
            ...
            return this.clone().primaryKeys().then((t => {
                const i = o => {
                    ...
                    return a.getMany({trans: r, keys: t.slice(o, o + h), cache: "immutable"}).then((d => {
                        const f = [], y = [], m = u ? [] : null, v = [];
                        for (let e = 0; e < h; ++e) {
                            const n = d[e], r = {value: O(n), primKey: t[o + e]};
                        ...
                        return Promise.resolve(f.length > 0 && a.mutate({trans: r, type: "add", values: f}).then((e => {
    ...
    delete() {
        ...
        return Bt(e) && (e.isPrimKey && !kt || 3 === t.type) ? this._write((n => {
            ...
            return e.table.core.count({trans: n, query: {index: r, range: s}}).then((t => e.table.core.mutate({
                trans: n,
                type: "deleteRange",
                range: s
...
class an {
    ...
    create(e) {
        ...
        return m(null === this._completion._state), (e = this.idbtrans = e || (this.db.core ? this.db.core.transaction(this.storeNames, this.mode, {durability: this.chromeTransactionDurability}) : t.transaction(this.storeNames, this.mode, {durability: this.chromeTransactionDurability}))).onerror = Ye((t => {
...
function cn(e, t, n) {
    return {name: e, primKey: t, indexes: n, mappedClass: null, idxByName: g(n, (e => [e.name, e]))}
}
...
function mn(e, t, r) {
    ...
    const {schema: i, hasGetAll: o} = function (e, t) {
        ...
        return {
            schema: {
                name: e.name, tables: r.map((e => t.objectStore(e))).map((e => {
                    const {keyPath: t, autoIncrement: r} = e, s = n(t), i = null == t, o = {}, a = {
                        ...
                        indexes: fn(e.indexNames).map((t => e.index(t))).map((e => {
                            const {name: t, unique: r, multiEntry: s, keyPath: i} = e,
                                a = {name: t, compound: n(i), keyPath: i, unique: r, multiEntry: s, extractKey: dn(i)};
                            return o[yn(i)] = a, a
                        })),
        ...
        const t = e.name;
        return {
            name: t, schema: e, mutate: function ({trans: e, type: n, keys: r, values: i, range: o}) {
                return new Promise(((a, u) => {
                    ...
                    if ("deleteRange" === n) {
                        if (4 === o.type) return a({numFailures: m, failures: y, results: [], lastResult: void 0});
                ...
                return n => new Promise(((r, i) => {
                    r = Ye(r);
                    const {trans: o, values: a, limit: u, query: l} = n, c = u === 1 / 0 ? void 0 : u, {
                        index: h,
                        range: d
                    } = l, f = o.objectStore(t), p = h.isPrimaryKey ? f : f.index(h.name), y = s(d);
                    if (0 === u) return r({result: []});
                    if (e) {
                        const e = a ? p.getAll(y, c) : p.getAllKeys(y, c);
                        e.onsuccess = e => r({result: e.target.result}), e.onerror = tn(i)
                    } else {
                        let e = 0;
                        const t = a || !("openKeyCursor" in p) ? p.openCursor(y) : p.openKeyCursor(y), n = [];
                        t.onsuccess = s => {
                            const i = t.result;
                            return i ? (n.push(a ? i.value : i.primaryKey), ++e === u ? r({result: n}) : void i.continue()) : r({result: n})
                        }, t.onerror = tn(i)
                    }
                }))
            }(o), openCursor: function ({trans: e, values: n, query: r, reverse: i, unique: o}) {
                return new Promise(((a, u) => {
                    a = Ye(a);
                    const {index: l, range: c} = r, h = e.objectStore(t), d = l.isPrimaryKey ? h : h.index(l.name),
                ...
                return new Promise(((e, o) => {
                    const a = n.objectStore(t), u = r.isPrimaryKey ? a : a.index(r.name), l = s(i),
    ...
    return a.forEach((e => u[e.name] = e)), {
        stack: "dbcore", transaction: e.transaction.bind(e), table(e) {
            ...
            return u[e]
        }, MIN_KEY: -1 / 0, MAX_KEY: hn(t), schema: i
    }
}
        ...
        t.forEach((t => {
            ...
            (!r || "value" in r && void 0 === r.value) && (t === e.Transaction.prototype || t instanceof e.Transaction ? l(t, n, {
                get() {
                    ...
                    u(this, n, {value: e, writable: !0, configurable: !0, enumerable: !0})
                }
            }) : t[n] = new e.Table(n, s))
        }))
    }))
...
function Kn({_novip: t}, n, r) {
    ...
    for (let e = 0; e < s.length; ++e) {
        ...
        for (let e = 0; e < o.indexNames.length; ++e) {
            const t = o.indexNames[e], r = o.index(t).keyPath,
    ...
    return je.race([s, ("undefined" == typeof navigator ? je.resolve() : jn()).then((() => new je(((s, o) => {
        ...
        c.onerror = tn(o), c.onblocked = Ye(e._fireOnBlocked), c.onupgradeneeded = Ye((t => {
            ...
            _t.push(e), r.onversionchange = Ye((t => {
                ...
                !An(e) && n !== Pt && Sn(e, t).put({name: n}).catch(ee)
            }(e._deps, l), s()
        }), o)
...
function Tn(e, t, n, r, s) {
    return je.resolve().then((() => {
        const i = Oe.transless || Oe, o = e._createTransaction(t, n, e._dbSchema, r), a = {trans: o, transless: i};
        ...
        return (l && "function" == typeof l.then ? je.resolve(l).then((e => o.active ? e : ft(new X.PrematureCommit("Transaction committed too early. See https://bit.ly/2kdckMn")))) : c.then((() => l))).then((e => (r && o._resolve(), o._completion.then((() => e))))).catch((e => (o._reject(e), ft(e))))
    }))
}
    ...
    stack: "dbcore", name: "VirtualIndexMiddleware", level: 1, create: function (e) {
        return {
            ...e, table(t) {
                ...
                function o(e, t, n) {
                    const r = yn(e), a = s[r] = s[r] || [], u = null == e ? 0 : "string" == typeof e ? 1 : e.length,
                        l = t > 0,
                        c = {...n, isVirtual: l, keyTail: t, keyLength: u, extractKey: dn(e), unique: !l && n.unique};
                ...
                const l = {
                    ...n, schema: {
                        ...r, primaryKey: a, indexes: i, getIndexByKeyPath: function (e) {
                            const t = s[yn(e)];
                            return t && t[0]
                        }
                    }, count: e => n.count(u(e)), query: e => n.query(u(e)), openCursor(t) {
                ...
                ...n, mutate(e) {
                    ...
                    function l(e) {
                        ...
                        return "delete" !== (e = "add" === e.type || "put" === e.type ? {
                            ...
                            const c = s.map(((n, s) => {
                                const c = l[s], h = {onerror: null, onsuccess: null};
...
const Ln = function (e, t) {
    ...
    r(this, arguments.length ? {d: 1, from: e, to: arguments.length > 1 ? t : e} : {d: 0})
};
...
function Vn(e, t, n) {
    ...
    if (Un(e)) return r(e, {from: t, to: n, d: 1});
    const i = e.l, o = e.r;
    if ($t(n, e.from) < 0) return i ? Vn(i, t, n) : e.l = {from: t, to: n, d: 1, l: null, r: null}, Gn(e);
    if ($t(t, e.to) > 0) return o ? Vn(o, t, n) : e.r = {from: t, to: n, d: 1, l: null, r: null}, Gn(e);
    ...
    return {
        next(e) {
            ...
            for (; t;) switch (t.s) {
                ...
                case 1:
                    if (t.s = 2, !n || $t(e, t.n.to) <= 0) return {value: t.n, done: !1};
                case 2:
                    if (t.n.r) {
                    ...
                    h[e] = function (t) {
                        ...
                        if (n) {
                            ...
                            if (a(d.name || "").add(p), !d.isPrimaryKey) {
                                if ("count" !== e) {
                                    const n = "query" === e && c && t.values && o.query({...t, values: !1});
                                    return o[e].apply(this, arguments).then((r => {
                                        if ("query" === e) {
                                            ...
                                            return e && Object.create(e, {
                                                ...
                                                value: {get: () => (n && u.addKey(e.primaryKey), e.value)}
                                            })
                                        }
                                        return r
                                    }))
...
class Xn {
    constructor(e, t) {
        ...
        s.dbReadyPromise = new je((e => {
            ...
            s.cancelOpen = t
        })), this._state = s, this.name = e, this.on = Dt(this, "populate", "blocked", "versionchange", "close", {ready: [ue, ee]}), this.on.ready.subscribe = y(this.on.ready.subscribe, (e => (t, n) => {
            Xn.vip((() => {
                const r = this._state;
        ...
        }, this.use(Fn), this.use(Nn), this.use(Qn), this.use($n), this.vip = Object.create(this, {_vip: {value: !0}}), r.forEach((e => e(this)))
    }
    ...
    const s = new Zn((s => {
        ...
        const f = e => {
            ...
            const t = {}, y = function (t) {
                i && et();
                const n = () => Ze(e, {subscr: t, trans: null}), r = Oe.trans ? at(Oe.transless, n) : n();
...
a(rr, {
    ...
    exists: e => new rr(e, {addons: []}).open().then((e => (e.close(), !0))).catch("NoSuchDatabaseError", (() => !1)),
    getDatabaseNames(e) {
        try {
    ...
    currentTransaction: {get: () => Oe.trans || null},
    ...
    if (!ir) {
        let t;
        wt ? (t = document.createEvent("CustomEvent"), t.initCustomEvent(sn, !0, !0, e)) : t = new CustomEvent(sn, {detail: e}), ir = !0, dispatchEvent(t), ir = !1
    }
