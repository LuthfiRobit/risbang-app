...
var Table = (function () {
    ...
    Table.prototype.put = function (obj, key) {
        ...
        return this._trans('readwrite', function (trans) {
            return _this.core.mutate({trans: trans, type: 'put', values: [objToAdd], keys: key != null ? [key] : null});
        })
            .then(function (res) {
                return res.numFailures ? DexiePromise.reject(res.failures[0]) : res.lastResult;
            })
    ...
    Table.prototype.bulkAdd = function (objects, keysOrOptions, options) {
        ...
        return this._trans('readwrite', function (trans) {
            ...
            return _this.core.mutate({
                ...
                .then(function (_a) {
                    var numFailures = _a.numFailures, results = _a.results, lastResult = _a.lastResult,
...
var WhereClause = (function () {
    ...
    WhereClause.prototype.inAnyRange = function (ranges, options) {
        var _this = this;
        var cmp = this._cmp, ascending = this._ascending, descending = this._descending, min = this._min,
            max = this._max;
        if (ranges.length === 0)
            return emptyCollection(this);
        ...
        queue.push(function () {
            ...
            if (contentUpgrade && version._cfg.version > oldVersion) {
                ...
                return (returnValue_1 && typeof returnValue_1.then === 'function' ?
                    DexiePromise.resolve(returnValue_1) : promiseFollowed.then(function () {
    ...
    return DexiePromise.resolve().then(function () {
        ...
        return (returnValue && typeof returnValue.then === 'function' ?
            DexiePromise.resolve(returnValue).then(function (x) {
                return trans.active ?
                    x
                    : rejection(new exceptions.PrematureCommit("Transaction committed too early. See https://bit.ly/2kdckMn"));
            })
            ...
            table: function (tableName) {
                ...
                var tableMiddleware = __assign(__assign({}, downTable), {
                    mutate: function (req) {
                        ...
                        var _a = dxTrans.table(tableName).hook, deleting = _a.deleting, creating = _a.creating,
                        ...
                        function addPutOrDelete(req) {
                            ...
                            return getExistingValues(downTable, req, keys).then(function (existingValues) {
                                ...
                                return downTable.mutate(req).then(function (_a) {
                                    var failures = _a.failures, results = _a.results, numFailures = _a.numFailures,
