    ...
    <div class="card mb-xl-8 mb-5 border-2">
        <div class="card-header">
            <h3 class="card-title align-items-start flex-column">
                <span class="card-label fw-bolder fs-3 mb-1 ">List Data Berita</span>
            </h3>
            <div class="card-toolbar">
                <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                    <a href="{{ route('cms.berita.create') }}" type="button" class="btn btn-sm btn-primary"
        ...
        <div class="card-body py-3">
            <div class="notice d-flex bg-light-primary border-primary mb-3 rounded border border-dashed p-3">
                <div class="d-flex flex-stack">
                    <div class="row">
                        <span class="fs-12 text-gray-700">Berikut ini adalah list data berita.
                        </span>
                        <div class="row">
                            <span style="color: #a1081f; font-weight: 500;">Data berita publish</span>
                            <span style="color: #a1081f; font-weight: 500;">Data berita tidak publish</span>
                        </div>
                    </div>
                </div>
            </div>
...
@section('script-for-this-page')
    ...
    @include('cms.berita.scripts.list')
@endsection
