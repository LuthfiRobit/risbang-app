<div class="modal fade" id="create_anggota" data-backdrop="static" tabindex="-1" role="dialog" aria-hidden="true">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-12 col-lg-12">
                            ...
                            <input type="file" class="form-control form-control-sm" name="gambar" id="gambar"
                                placeholder="Masukkan Profil" accept=".png, .jpg, .jpeg" required />
                            <ul id="error-list" class="list-unstyled text-danger"></ul>
                        </div>
                        <div class="col-sm-12 col-md-12 col-lg-12">
                            <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                            ...
                            <select class="selectpicker form-control form-control-sm" name="urutan" id="urutan"
