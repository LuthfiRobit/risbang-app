   <div id="kt_header" style="" class="header align-items-stretch">
       ...
       <div class="header-brand">
           <!--begin::Logo-->
           <a href="#">
               <img alt="Logo" src="{{ asset('assets/media/logos/logo_unas_2.png') }}" class="h-50px h-lg-50px" />
           </a>
           <!--end::Logo-->
               ...
               <div class="page-title d-flex flex-column me-5">
                   ...
                   <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 pt-1">
                       ...
                       <li class="breadcrumb-item">
                           {{-- <span class="bg-gray-200 w-5px h-2px bi bi-arrow-bar-left"></span> --}}

                           <a href="{{ url()->previous() }}" class="text-muted text-hover-primary">
                               <span class="bi bi-arrow-bar-left" aria-hidden="true"></span> Kembali
                           </a>
                       </li>
                       <!--end::Item-->
                       <!--begin::Item-->
                       {{-- <li class="breadcrumb-item text-muted">
                           <a href="../../demo8/dist/index.html" class="text-muted text-hover-primary">Kembali</a>
                       </li> --}}
                       <!--end::Item-->
                       <!--begin::Item-->
               ...
               <div class="d-flex align-items-center overflow-auto pt-3 pt-lg-0">
                   ...
                   <div class="d-flex align-items-center">
                       ...
                       {{-- <span class="fs-7 text-gray-700 fw-bolder pe-3">
                           {{ \Carbon\Carbon::now()->isoFormat('dddd, D MMMM Y | HH:mm:ss a') }}
                       </span> --}}
                       <span id="real-time-clock" class="fs-7 text-gray-700 fw-bolder pe-3">
                       </span>
                       <!--end::Label-->
                       <!--begin::Actions-->
                       <div class="d-flex">
                           <form action="{{ route('logout') }}" class="d-block" method="POST" id="logoutform2">
                               @csrf
                               <!--begin::Quick links-->
                               <div class="d-flex align-items-center">
                                   <!--begin::Menu wrapper-->
                                   <button class="btn btn-sm btn-icon btn-icon-muted btn-active-icon-primary"
                                       data-kt-menu-trigger="click" data-kt-menu-attach="parent"
                                       data-kt-menu-placement="bottom-end" data-kt-menu-flip="bottom" type="submit"
                                       id="logoutButton2">
