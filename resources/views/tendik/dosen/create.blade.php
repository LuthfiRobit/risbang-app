                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-12 col-lg-4">
                            ...
                            <select class="selectpicker form-control form-control-sm" name="prodi" id="prodi"
                        ...
                        <div class="col-sm-12 col-md-12 col-lg-4">
                            ...
                            <select class="selectpicker form-control form-control-sm" name="status" id="status"
                                data-live-search="true" title="Pilih Status">
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-12 col-lg-4">
                            ...
                            <!--end::Label-->
                            <input type="text" class="form-control form-control-sm" name="nama_dosen" id="nama_dosen"
                        ...
                        <div class="col-sm-12 col-md-12 col-lg-4">
                            ...
                            <!--end::Label-->
                            <input type="text" class="form-control form-control-sm" name="nidn" id="nidn"
