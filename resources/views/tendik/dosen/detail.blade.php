                ...
                <div id="show_data" style="display: none;">
                    <div class="row">
                        <div class="col-sm-12 col-md-12 col-lg-4">
                            ...
                            <p id="show_data_nama_dosen"></p>
                        </div>
                        <div class="col-sm-12 col-md-12 col-lg-4">
                            <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                                <span>NIK</span>
                            </label>
                            <p id="show_data_nik"></p>
                        </div>
                        <div class="col-sm-12 col-md-12 col-lg-4">
                            <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                                <span>NIDN</span>
                            </label>
                            <p id="show_data_nidn"></p>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-12 col-md-12 col-lg-4">
                            ...
                            <p id="show_data_fakultas"></p>
                        </div>
                        <div class="col-sm-12 col-md-12 col-lg-4">
                            <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                                <span>Prodi</span>
                            </label>
                            <p id="show_data_prodi"></p>
                        </div>
                        <div class="col-sm-12 col-md-12 col-lg-4">
                            <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-12 col-lg-4">
                            <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                                <span>Status Serdos</span>
                            </label>
                            <p id="show_data_status_serdos"></p>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-12 col-md-12 col-lg-4">
