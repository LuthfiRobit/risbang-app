                ...
                <div class="modal-body">
                    <div class="row justify-content-md-center">
                        ...
                        <div class="col-sm-12">
                            ...
                            <!--end::Label-->
                            <input type="text" class="form-control form-control-sm" name="nama_tahun_akademik"
                                id="nama_tahun_akademik" placeholder="Masukkan Nama Tahun Akademik" required readonly />
                            <ul id="error-list" class="list-unstyled text-danger"></ul>
                        </div>
                        <div class="col-sm-12">
                            <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                            ...
                            <!--end::Label-->
                            <input type="number" class="form-control form-control-sm date-own-2" name="dana_maksimal"
                                id="dana_maksimal" min="1" placeholder="Masukkan Dana Maksimal Untuk Proposal"
                                required />
                            <ul id="error-list" class="list-unstyled text-danger"></ul>
                        </div>
                        <div class="col-sm-12">
