<script>
        ...
        DataManager.fetchData(detail.replace(':id', id))
            .then(function(response) {
                if (response.success) {
                    ...
                    $("#edit_data_nama_prodi").val(response.data.nama_prodi);
                    // $("#edit_data_nama_kaprodi").val(response.data.nama_kaprodi);
    ...
    $("#bt_submit_edit").on("submit", function(e) {
        ...
        Swal.fire({
            ...
            if (result.value) {
                const update = '{{ route('tendik.prodi.update', [':id']) }}';
                const input = {
                    "fakultas": $("#edit_data_fakultas").val(),
                    "nama_prodi": $("#edit_data_nama_prodi").val(),
                    // "nama_kaprodi": $("#edit_data_nama_kaprodi").val(),
