                ...
                <div class="modal-body">
                    <div class="row justify-content-md-center">
                        ...
                        <div class="col-sm-12">
                            ...
                            <!--end::Label-->
                            <input type="text" class="form-control form-control-sm" name="edit_data_nama_prodi"
                                id="edit_data_nama_prodi" placeholder="Masukkan Nama Prodi" required />
                            <ul id="error-list" class="list-unstyled text-danger"></ul>
                        </div>
                        <div class="col-sm-12">
                            <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                        ...
                        {{-- <div class="col-sm-12">
                            ...
                            <input type="text" minlength="3" class="form-control form-control-sm date-own-1"
                                name="edit_data_nama_kaprodi" id="edit_data_nama_kaprodi"
                                placeholder="Masukkan Nama Kaprodi" required />
                            <ul id="error-list" class="list-unstyled text-danger"></ul>
                        </div> --}}
                        <div class="col-sm-12">
                            <label class="d-flex align-items-center fs-6 fw-bold mb-2">
