                ...
                <div class="modal-body">
                    <div class="row justify-content-md-center">
                        <div class="col-sm-12">
                            ...
                            <!--end::Label-->
                            <input type="text" class="form-control form-control-sm" name="nama_fakultas"
                                id="nama_fakultas" placeholder="Masukkan Nama Fakultas" minlength="3" required />
                        ...
                        {{-- <div class="col-sm-12">
                            ...
                            <!--end::Label-->
                            <input type="text" class="form-control form-control-sm" name="nama_dekan" id="nama_dekan"
                                placeholder="Masukkan Nama Dekan" minlength="3" required />
                            <ul id="error-list" class="list-unstyled text-danger"></ul>
                        </div> --}}
                        <div class="col-sm-12">
                            <label class="d-flex align-items-center fs-6 fw-bold mb-2">
