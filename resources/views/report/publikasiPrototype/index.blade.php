...
@section('title-one', 'Report | Prototype Luaran Publikasi')
...
@section('content')
    <div class="card mb-xl-8 mb-5 border-2">
        <div class="card-header">
            <h3 class="card-title align-items-start flex-column">
                <span class="card-label fw-bolder fs-3 mb-1 ">List Prototype Luaran Publikasi</span>
            </h3>
        ...
        <div class="card-body py-3">
            <div class="notice d-flex bg-light-primary border-primary mb-3 rounded border border-dashed p-3">
                <div class="d-flex flex-stack">
                    <div class="row">
                        <span class="fs-12 text-gray-700">Berikut ini adalah daftar dari prototype luaran publikasi dosen.
                        </span>
                    </div>
                </div>
            </div>
    ...
    @include('report.publikasiPrototype.detail')
@endsection
...
@section('script-for-this-page')
    ...
    @include('report.publikasiPrototype.scripts.list')
    @include('report.publikasiPrototype.scripts.detail')
@endsection
