<script>
    $("#form_detail").on("show.bs.modal", function(e) {
        ...
        const detail = '{{ route('report.publikasi.luaran.produk.show', [':id']) }}';
        ...
        DataManager.fetchData(detail.replace(':id', id))
            .then(function(response) {
                if (response.success) {
                    ...
                    $("#show_mitra").text(response.data.mitra != null ? response.data.mitra : '------');
                    $("#show_jenis_mitra").text(response.data.jenis_mitra != null ? response.data
                        .jenis_mitra : '------');
                    $("#show_negara_mitra").text(response.data.negara_mitra != null ? response.data
                        .negara_mitra : '------');
