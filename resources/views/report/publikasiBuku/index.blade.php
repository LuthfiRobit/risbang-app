...
@section('title-one', 'Report | Buku Luaran Publikasi')
...
@section('content')
    <div class="card mb-xl-8 mb-5 border-2">
        <div class="card-header">
            <h3 class="card-title align-items-start flex-column">
                <span class="card-label fw-bolder fs-3 mb-1 ">List Buku Luaran Publikasi</span>
            </h3>
        ...
        <div class="card-body py-3">
            <div class="notice d-flex bg-light-primary border-primary mb-3 rounded border border-dashed p-3">
                <div class="d-flex flex-stack">
                    <div class="row">
                        <span class="fs-12 text-gray-700">Berikut ini adalah daftar dari buku luaran publikasi dosen.
                        </span>
                    </div>
                </div>
            </div>
            <div class="row g-2">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <select class="selectpicker form-control form-control-sm" name="filter_kate" id="filter_kate"
                        data-live-search="true" title="Pilih Kategori Buku" required>
                        <option value="">Semua</option>
                ...
                <table id="example" class="table table-row-dashed table-row-gray-500 align-middle gs-0 gy-3"
                    ...
                    <thead>
                        <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0 ">
                            ...
                            <th class="min-w-50px">Terbit</th>
                            <th class="min-w-100px">Kategori Buku</th>
    ...
    @include('report.publikasiBuku.detail')
@endsection
...
@section('script-for-this-page')
    ...
    @include('report.publikasiBuku.scripts.list')
    @include('report.publikasiBuku.scripts.detail')
@endsection
