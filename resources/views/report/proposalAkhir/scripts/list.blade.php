<script>
    ...
    function load_data() {
        ...
        const table = $('#example').DataTable({
            ...
            ajax: {
                url: '{{ route('report.proposal.akhir.list') }}',
                cache: false,
                data: function(d) {
            ...
            columns: [{
                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        let bg = (row.keaslian == 'y') ? 'primary' : 'success';
                        let text = (row.keaslian == 'y') ? 'Terkonfirmasi' : 'Belum Terkonfirmasi';
                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        ...
                        return `<div class="badge badge-light-${bg} fw-bold">${row.status}</div>`;
                    },
                    orderable: false,
                    searchable: false,
                },
        ...
        $('#filter_ta, #filter_fakultas, #filter_prodi, #filter_jenis, #filter_status').change(function() {
            table.draw();
        });
