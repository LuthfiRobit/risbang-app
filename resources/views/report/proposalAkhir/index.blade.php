...
@section('title-one', 'Report | Akhir Proposal')
...
@section('content')
    <div class="card mb-xl-8 mb-5 border-2">
        <div class="card-header">
            <h3 class="card-title align-items-start flex-column">
                <span class="card-label fw-bolder fs-3 mb-1 ">List Akhir Proposal</span>
            </h3>
        ...
        <div class="card-body py-3">
            <div class="notice d-flex bg-light-primary border-primary mb-3 rounded border border-dashed p-3">
                <div class="d-flex flex-stack">
                    <div class="row">
                        <span class="fs-12 text-gray-700">Berikut ini adalah daftar dari akhir proposal dosen.
                        </span>
                    </div>
                </div>
            </div>
            <div class="row g-2">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <select class="selectpicker form-control form-control-sm" name="filter_status" id="filter_status"
                        data-live-search="true" title="Pilih Status" required>
                        <option value="">Semua</option>
                ...
                <table id="example" class="table table-row-dashed table-row-gray-500 align-middle gs-0 gy-3"
                    ...
                    <thead>
                        <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0 ">
                            ...
                            <th class="min-w-50px">Keaslian</th>
    ...
    @include('report.proposalAkhir.detail')
@endsection
...
@section('script-for-this-page')
    ...
    @include('report.proposalAkhir.scripts.list')
    @include('report.proposalAkhir.scripts.detail')
@endsection
