                ...
                <div id="show_data" style="display: none;">
                    ...
                    <div class="row mb-3">
                        <div class="col-12 mb-2">
                            <div class="row">
                                <div class="col-3">
                                    <span class="fs-6 fw-bold">Jenis Publikasi</span>
                                </div>
                                <div class="col-9">
                                    <span class="fs-6 fw-bold">:</span> <span id="show_jenis_publikasi"
                                        class="mb-0"></span>
                                </div>
                            </div>
                        </div>
                        <div class="col-12 mb-2">
                            <div class="row">
                                ...
                                <div class="col-9">
                                    <span class="fs-6 fw-bold">:</span> <span id="show_penerbit"
                                        class="mb-0"></span>
                                </div>
                            </div>
                        </div>
