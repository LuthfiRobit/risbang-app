    ...
    <div class="card mb-xl-8 mb-5 border-2">
        <div class="card-header">
            <h3 class="card-title align-items-start flex-column">
                <span class="card-label fw-bolder fs-3 mb-1 ">List Tahun Akademik Reviewer</span>
            </h3>
        </div>
        <div class="card-body py-3">
            <div class="notice d-flex bg-light-primary border-primary mb-3 rounded border border-dashed p-3">
                <div class="d-flex flex-stack">
                    <div class="row">
                        <span class="fs-12 text-gray-700">Berikut ini adalah daftar dari data tahun akademik reviewer.
                        </span>
                        <div class="row">
                            <span style="color: #a1081f; font-weight: 500;">Data akumulasi terploting reviewer per tahun
                                akademik</span>
                            <span style="color: #0b7a44 ; font-weight: 500;">Data akumulasi dosen terploting per tahun
                                akademik</span>
                        </div>
                    </div>
                </div>
                ...
                <table id="example" class="table table-row-dashed table-row-gray-500 align-middle gs-0 gy-3"
                    ...
                    <thead>
                        <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0 ">
                            ...
                            <th class="min-w-125px">Jumlah Reviewer</th>
...
@section('script-for-this-page')
    ...
    @include('setting.plotingReviewer.scripts.list')
