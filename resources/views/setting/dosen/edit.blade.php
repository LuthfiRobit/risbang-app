                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-sm-12 col-md-12 col-lg-12">
                            ...
                            <select class="selectpicker form-control form-control-sm" name="edit_data_dosen"
                                id="edit_data_dosen" data-live-search="true" title="Pilih Dosen" required>
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-12 col-lg-4">
                            ...
                            <select class="selectpicker form-control form-control-sm" name="edit_data_role"
                                id="edit_data_role" data-live-search="true" title="Pilih Role Dosen" required>
