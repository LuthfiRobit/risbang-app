    ...
    <div class="card mb-xl-8 mb-5 border-2">
        <div class="card-header">
            <h3 class="card-title align-items-start flex-column">
                <span class="card-label fw-bolder fs-3 mb-1 ">List Review Akhir Proposal Tahun Akademik
                ...
                <table id="example" class="table table-row-dashed table-row-gray-500 align-middle gs-0 gy-3 dt-responsive"
                    ...
                    <thead>
                        <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0 ">
                            ...
                            <th class="min-w-75px">Program Studi</th>
                            <th class="min-w-50px">Penelitian</th>
                            <th class="min-w-50px">Pengabdian</th>
                            <th class="min-w-50px">Keaslian Penelitian</th>
                            <th class="min-w-50px">Keaslian Pengabdian</th>
...
@section('script-for-this-page')
    ...
    @include('review.akhir.scripts.listDsn')
@endsection
