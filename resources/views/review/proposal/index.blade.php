    ...
    <div class="card mb-xl-8 mb-5 border-2">
        <div class="card-header">
            <h3 class="card-title align-items-start flex-column">
                <span class="card-label fw-bolder fs-3 mb-1 ">List Review Pengajuan Proposal</span>
            </h3>
        </div>
            ...
            <div class="notice d-flex bg-light-primary border-primary mb-3 rounded border border-dashed p-3">
                <div class="d-flex flex-stack">
                    <div class="row">
                        ...
                        <div class="row">
                            <span style="color: #a1081f; font-weight: 500;">Klik detail untuk melihat list dosen yang perlu
                                di review</span>
                        </div>
                    </div>
                </div>
                ...
                <table id="example" class="table table-row-dashed table-row-gray-500 align-middle gs-0 gy-3 dt-responsive"
                    ...
                    <thead>
                        <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0 ">
                            ...
                            <th class="min-w-100px">Jumlah Dosen</th>
                        </tr>
                    </thead>
...
@section('script-for-this-page')
    ...
    @include('review.proposal.scripts.listIndex')
@endsection
