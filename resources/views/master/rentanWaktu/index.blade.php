...
@section('title-one', 'Master | Data Rentan Waktu')
...
@section('content')
    ...
    <div class="card mb-xl-8 mb-5 border-2">
        <div class="card-header">
            <h3 class="card-title align-items-start flex-column">
                <span class="card-label fw-bolder fs-3 mb-1 ">List Rentan Waktu</span>
            </h3>
            <div class="card-toolbar">
                <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                    <a type="button" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#form_create"
                        aria-label="Close" data-dismiss="modal" title='Create'>Tambah Rentan Waktu</a>
                </div>
            </div>
        </div>
        <div class="card-body py-3">
            <div class="notice d-flex bg-light-primary border-primary mb-3 rounded border border-dashed p-3">
                <div class="d-flex flex-stack">
                    <div class="row">
                        <span class="fs-12 text-gray-700">Berikut ini adalah daftar dari Rentan Waktu data.
                        </span>
                        <div class="row">
                            <span style="color: #a1081f; font-weight: 500;">Data Rentan Waktu tidak aktif</span>
                            <span style="color: #0b7a44 ; font-weight: 500;">Data Rentan Waktu aktif</span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <table id="example" class="table table-row-dashed table-row-gray-500 align-middle gs-0 gy-3 dt-responsive"
                    ...
                    <thead>
                        <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0 ">
                            ...
                            <th class="min-w-125px">Rentan Waktu</th>
    ...
    {{-- </div> --}}
    @include('master.rentanWaktu.create')
    @include('master.rentanWaktu.detail')
    @include('master.rentanWaktu.edit')
@endsection
...
@section('script-for-this-page')
    ...
    @include('master.rentanWaktu.scripts.list')
    @include('master.rentanWaktu.scripts.detail')
    @include('master.rentanWaktu.scripts.create')
    @include('master.rentanWaktu.scripts.edit')
    @include('master.rentanWaktu.scripts.activation')
@endsection
