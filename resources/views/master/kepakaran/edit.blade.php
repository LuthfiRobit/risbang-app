                ...
                <div class="modal-body">
                    <div class="row justify-content-md-center">
                        <div class="col-sm-12">
                            ...
                            <!--end::Label-->
                            <input type="text" class="form-control form-control-sm" name="edit_data_nama_kepakaran"
                                id="edit_data_nama_kepakaran" placeholder="Masukkan Nama Kepakaran" required />
                        ...
                        <div class="col-sm-12">
                            ...
                            <select class="selectpicker form-control form-control-sm" name="edit_data_bidang_ilmu"
                                id="edit_data_bidang_ilmu" data-live-search="true" title="Pilih Bidang Ilmu">
