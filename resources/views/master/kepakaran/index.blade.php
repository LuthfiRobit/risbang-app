...
@section('title-one', 'Master | Data Kepakaran')
...
@section('content')
    ...
    <div class="card mb-xl-8 mb-5 border-2">
        <div class="card-header">
            <h3 class="card-title align-items-start flex-column">
                <span class="card-label fw-bolder fs-3 mb-1 ">List Kepakaran</span>
            </h3>
            <div class="card-toolbar">
                <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                    <a type="button" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#form_create"
                        aria-label="Close" data-dismiss="modal" title='Create'>Tambah Kepakaran</a>
                </div>
            </div>
        </div>
        <div class="card-body py-3">
            <div class="notice d-flex bg-light-primary border-primary mb-3 rounded border border-dashed p-3">
                <div class="d-flex flex-stack">
                    <div class="row">
                        <span class="fs-12 text-gray-700">Berikut ini adalah daftar dari Kepakaran data.
                        </span>
                        <div class="row">
                            <span style="color: #a1081f; font-weight: 500;">Data Kepakaran tidak aktif</span>
                            <span style="color: #0b7a44 ; font-weight: 500;">Data Kepakaran aktif</span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <table id="example" class="table table-row-dashed table-row-gray-500 align-middle gs-0 gy-3 dt-responsive"
                    ...
                    <thead>
                        <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0 ">
                            ...
                            <th class="min-w-125px">Kepakaran</th>
    ...
    {{-- </div> --}}
    @include('master.kepakaran.create')
    @include('master.kepakaran.detail')
    @include('master.kepakaran.edit')
@endsection
...
@section('script-for-this-page')
    ...
    @include('master.kepakaran.scripts.list')
    @include('master.kepakaran.scripts.detail')
    @include('master.kepakaran.scripts.create')
    @include('master.kepakaran.scripts.edit')
    @include('master.kepakaran.scripts.activation')
@endsection
