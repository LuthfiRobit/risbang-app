<script>
    ...
    function handleFormSubmit(formId, fileInputId, urlInputId, keaslianInputId, jenis) {
        $(formId).on("submit", function(e) {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    const action = "{{ route('proposal.akhir.store') }}";
                    ...
                    formData.append("keaslian", $(keaslianInputId).is(":checked") ? 'y' : 't');

                    if (fileInput[0].files.length > 0) {
                        formData.append("file_akhir", fileInput[0].files[0]);
                    }
    ...
    $(document).ready(function() {
        handleFormSubmit("#fm_submit_akhir_penelitian", "#file_akhir_pene", "#link_akhir_pene",
            "#pernyataan_pene", "Penelitian");
        handleFormSubmit("#fm_submit_akhir_pengabdian", "#file_akhir_peng", "#link_akhir_peng",
            "#pernyataan_peng", "Pengabdian");
    });
</script>
