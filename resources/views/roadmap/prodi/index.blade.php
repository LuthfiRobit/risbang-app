...
@section('title-one', 'Halaman Kelola Roadmap Prodi')
...
@section('content')
    ...
    <div class="card mb-xl-8 mb-5 border-2">
        <div class="card-header">
            <h3 class="card-title align-items-start flex-column">
                <span class="card-label fw-bolder fs-3 mb-1 ">List Data Roadmap Prodi</span>
            </h3>
        ...
        <div class="card-body py-3">
            <div class="notice d-flex bg-light-primary border-primary mb-3 rounded border border-dashed p-3">
                <div class="d-flex flex-stack">
                    <div class="row">
                        <span class="fs-12 text-gray-700">Berikut ini adalah list data roadmap prodi.
                        </span>
                        <div class="row">
                            @if (Auth::user()->dosen_role == 'kaprodi')
    ...
    @if (Auth::user()->dosen_role == 'kaprodi')
        @include('roadmap.prodi.create')
        @include('roadmap.prodi.edit')
    @endif
    @if (Auth::user()->user_role == 'admin')
        @include('roadmap.prodi.review')
    @endif
@endsection
...
@section('script-for-this-page')
    ...
    @include('roadmap.prodi.scripts.list')
    @if (Auth::user()->dosen_role == 'kaprodi')
        @include('roadmap.prodi.scripts.create')
        @include('roadmap.prodi.scripts.edit')
    @endif
    @if (Auth::user()->user_role == 'admin')
        @include('roadmap.prodi.scripts.review')
    @endif
@endsection
