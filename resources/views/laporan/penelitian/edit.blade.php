...
@section('content')
        ...
        <div class="card mb-xl-8 mb-2 border-2">
            <div class="card-header">
                <h3 class="card-title align-items-start flex-column">
                    <span class="card-label fw-bolder fs-3 mb-1 ">Edit Penelitian</span>
    ...
    @include('laporan.penelitian.modals')
...
@section('script-for-this-page')
    ...
    @include('laporan.penelitian.scripts.tabels')
    @include('laporan.penelitian.scripts.show')
    @include('laporan.penelitian.scripts.update')
    @include('laporan.penelitian.scripts.createPenulis')
@endsection
