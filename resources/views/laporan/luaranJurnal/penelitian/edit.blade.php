        ...
        <div class="card mb-xl-8 mb-2 border-2">
            <div class="card-header">
                <h3 class="card-title align-items-start flex-column">
                    <span class="card-label fw-bolder fs-3 mb-1 ">Edit Jurnal Penelitian</span>
            ...
            <div class="card-body py-3">
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-12 col-lg-12">
                        ...
                        <textarea class="form-control form-control-sm" placeholder="Masukkan Abstrak Penelitian" name="abstrak"
...
@section('script-for-this-page')
    ...
    @include('laporan.luaranJurnal.penelitian.scripts.tabels')
    @include('laporan.luaranJurnal.penelitian.scripts.show')
    @include('laporan.luaranJurnal.penelitian.scripts.update')
