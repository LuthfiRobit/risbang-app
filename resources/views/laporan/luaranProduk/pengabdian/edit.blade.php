        ...
        <div class="card mb-xl-8 mb-2 border-2">
            <div class="card-header">
                <h3 class="card-title align-items-start flex-column">
                    <span class="card-label fw-bolder fs-3 mb-1 ">Edit Produk Pengabdian</span>
...
@section('script-for-this-page')
    ...
    {{-- @include('laporan.luaranProduk.pengabdian.scripts.tabels') --}}
    @include('laporan.luaranProduk.pengabdian.scripts.show')
    @include('laporan.luaranProduk.pengabdian.scripts.update')
