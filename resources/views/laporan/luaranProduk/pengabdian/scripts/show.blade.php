<script>
    $(document).ready(function() {
        ...
        const urlShow = '{{ route('laporan.pengabdian.luaran.produk.show', [':id']) }}';
        ...
        function fetchOwnerOptions() {
            return new Promise((resolve, reject) => {
                const ownerUrl = '{{ route('global.arsip.peng.list.json') }}';
                fetch(ownerUrl)
        ...
        function handleFileAndCoverExistence(data) {
            if (data.file_arsip_produk) {
                appendLinkToElement("#exist-file", "files/arsipProduk/", data.file_arsip_produk,
                    "Lihat File");
            }
            if (data.cover_arsip_produk) {
                appendLinkToElement("#exist-cover", "imgs/arsipProduk/", data.cover_arsip_produk,
                    "Lihat Cover");
            }
            if (data.publish === 'y') {
        ...
        function populateFormFields(data) {
            ...
            $("#jenis_mitra").val(data.jenis_mitra).selectpicker('refresh').selectpicker('render');
            $("#negara_mitra").val(data.negara_mitra);
