        ...
        <div class="card mb-xl-8 mb-2 border-2">
            <div class="card-header">
                <h3 class="card-title align-items-start flex-column">
                    <span class="card-label fw-bolder fs-3 mb-1 ">Edit Prototype Pengabdian</span>
                ...
                <div class="row">
                    <div class="col-lg-12 lg-md-12 col-sm-12">
                        ...
                        <select class="selectpicker form-control form-control-sm form-select-sm" name="arsip"
                            id="arsip" data-live-search="true" title="Pilih Judul Pengabdian" data-size="5" required>
                        </select>
        ...
        <div class="card mb-xl-8 mt-0 border-2">
            <div class="card-header">
                <h3 class="card-title align-items-start flex-column">
                    ...
                    <span class="d-flex align-items-center text-gray-400 me-5 mb-2 fs-8">
                        Penulis dosen dalam kampus berdasarkan pengabdian.
                    </span>
                </h3>
            </div>
            <div class="card-body py-3">
        ...
        <div class="card mb-xl-8 mt-0 border-2">
            <div class="card-header">
                <h3 class="card-title align-items-start flex-column">
                    ...
                    <span class="d-flex align-items-center text-gray-400 me-5 mb-2 fs-8">
                        Penulis dosen luar kampus berdasarkan pengabdian.
                    </span>
                </h3>
            </div>
            <div class="card-body py-3">
        ...
        <div class="card mb-xl-8 mt-0 border-2">
            <div class="card-header">
                <h3 class="card-title align-items-start flex-column">
                    ...
                    <span class="d-flex align-items-center text-gray-400 me-5 mb-2 fs-8">
                        Penulis lain berdasarkan pengabdian.
                    </span>
                </h3>
            </div>
            <div class="card-body py-3">
...
@section('script-for-this-page')
    ...
    {{-- @include('laporan.luaranPrototype.pengabdian.scripts.tabels') --}}
    @include('laporan.luaranPrototype.pengabdian.scripts.show')
    @include('laporan.luaranPrototype.pengabdian.scripts.update')
