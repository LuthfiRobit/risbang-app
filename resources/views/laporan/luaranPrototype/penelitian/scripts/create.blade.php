<script>
    ...
    $('#form_create').on("submit", function(e) {
        ...
        Swal.fire({
            ...
            if (result.value) {
                const action = "{{ route('laporan.penelitian.luaran.prototype.store') }}";
                    ...
                    if (response.success) {
                        ...
                        setTimeout(function() {
                            ...
                            window.location.href =
                                "{{ route('laporan.penelitian.luaran.prototype.index') }}";
                        }, 2000);
    ...
    $(document).ready(function() {
        const urlJudul =
            '{{ route('global.arsip.pene.list.json') }}'; // Adjust the route name accordingly
        fetch(urlJudul)
