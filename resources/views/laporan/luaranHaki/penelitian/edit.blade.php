        ...
        <div class="card mb-xl-8 mb-2 border-2">
            <div class="card-header">
                <h3 class="card-title align-items-start flex-column">
                    <span class="card-label fw-bolder fs-3 mb-1 ">Edit HKI Penelitian</span>
...
@section('script-for-this-page')
    ...
    @include('laporan.luaranHaki.penelitian.scripts.tabels')
    @include('laporan.luaranHaki.penelitian.scripts.show')
    @include('laporan.luaranHaki.penelitian.scripts.update')
