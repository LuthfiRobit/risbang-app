...
@section('title-one', 'Halaman Kelola Luaran HKI Pengabdian Dosen')
    ...
    <div class="card mb-xl-8 mb-5 border-2">
        <div class="card-header">
            <h3 class="card-title align-items-start flex-column">
                <span class="card-label fw-bolder fs-3 mb-1 ">List Data Luaran HKI Pengabdian</span>
            </h3>
            <div class="card-toolbar">
                <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                    <a href="{{ route('laporan.pengabdian.luaran.haki.create') }}" type="button"
        ...
        <div class="card-body py-3">
            <div class="notice d-flex bg-light-primary border-primary mb-3 rounded border border-dashed p-3">
                <div class="d-flex flex-stack">
                    <div class="row">
                        <span class="fs-12 text-gray-700">Berikut ini adalah list data luaran haki pengabdian dosen.
                        </span>
                        <div class="row">
...
@section('script-for-this-page')
    ...
    @include('laporan.luaranHaki.pengabdian.scripts.list')
@endsection
