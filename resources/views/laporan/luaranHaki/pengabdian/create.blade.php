        ...
        <div class="card mb-xl-8 mb-2 border-2">
            <div class="card-header">
                <h3 class="card-title align-items-start flex-column">
                    <span class="card-label fw-bolder fs-3 mb-1 ">Tambah HKI Pengabdian</span>
            ...
            <div class="card-body py-3">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 lg-md-12 col-sm-12">
                        <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 lg-md-6 col-sm-12">
                        ...
                        <input type="file" class="form-control form-control-sm" name="file" id="file"
                            placeholder="Masukkan File HKI" accept=".pdf," required />
                        <ul id="error-list" class="list-unstyled text-danger"></ul>
                    </div>
                </div>
                <div class="row">
...
@section('script-for-this-page')
    ...
    @include('laporan.luaranHaki.pengabdian.scripts.create')
