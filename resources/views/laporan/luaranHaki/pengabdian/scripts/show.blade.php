<script>
    ...
    $(document).ready(function() {
        ...
        const urlShow = '{{ route('laporan.pengabdian.luaran.haki.show', [':id']) }}';
            ...
            DataManager.fetchData(urlShowReplaced)
                .then(function(response) {
                    if (response.success) {
                        ...
                        if (response.data.file_arsip_haki !== null) {
                            const urlPeng = "{{ asset('files/arsipHaki/') }}" + "/" + response.data
                                .file_arsip_haki;
                            let ex_file =
                        ...
                        $("#kategori").val(response.data.kategori_haki);
                        $("#jenis").append(new Option(response.data.jenis_haki, response.data.jenis_haki,
                            false, 'selected'));
                        $("#pemegang").val(response.data.pemegang);
