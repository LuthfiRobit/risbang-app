...
@section('title-one', 'Halaman Kelola Luaran HKI Dosen')
        ...
        <div class="card mb-xl-8 mb-2 border-2">
            <div class="card-header">
                <h3 class="card-title align-items-start flex-column">
                    <span class="card-label fw-bolder fs-3 mb-1 ">Edit HKI Pengabdian</span>
            ...
            <div class="card-body py-3">
                ...
                <div class="row">
                    <div class="col-lg-12 lg-md-12 col-sm-12">
                        <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                            <span class="required">Judul HKI</span>
                        </label>
                        <input type="text" class="form-control form-control-sm" name="judul" id="judul"
                            placeholder="Masukkan Judul HKI" required />
                        <ul id="error-list" class="list-unstyled text-danger"></ul>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-4 lg-md-4 col-sm-12">
                        <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                            <span class="required">Kategori HKI</span>
                        </label>
                        <select class="selectpicker form-control form-control-sm form-select-sm" name="kategori"
                            id="kategori" data-live-search="true" title="Pilih Kategori HKI" required>
                            <option value="Haki">Hak Cipta</option>
                    ...
                    <div class="col-lg-4 lg-md-4 col-sm-12">
                        <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                            <span class="required">Jenis HKI</span>
                        </label>
                        <select class="selectpicker form-control form-control-sm form-select-sm" name="jenis"
                            id="jenis" data-live-search="true" title="Pilih Jenis HKI" required>
                        </select>
                        <ul id="error-list" class="list-unstyled text-danger"></ul>
                    </div>
                    <div class="col-lg-4 lg-md-4 col-sm-12">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 lg-md-6 col-sm-12">
                        <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                            <span class="required">No. Hak Cipta</span>
                        </label>
                        <input type="text" class="form-control form-control-sm" name="nomor" id="nomor"
                            placeholder="Masukkan No. Hak Cipta" required />
                        <ul id="error-list" class="list-unstyled text-danger"></ul>
                    </div>
                    <div class="col-lg-4 lg-md-6 col-sm-12">
                        <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                            <span class="required">Pemegang Hak Cipta</span>
                        </label>
                        <input type="text" class="form-control form-control-sm" name="pemegang" id="pemegang"
                            placeholder="Masukkan Pemegang Hak Cipta" required />
                        <ul id="error-list" class="list-unstyled text-danger"></ul>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-12 col-lg-12">
                        ...
                        <textarea class="form-control form-control-sm" placeholder="Masukkan Deskripsi HKI" name="deskripsi" id="deskripsi"
...
@section('script-for-this-page')
    ...
    @include('laporan.luaranHaki.pengabdian.scripts.tabels')
    @include('laporan.luaranHaki.pengabdian.scripts.show')
    @include('laporan.luaranHaki.pengabdian.scripts.update')
