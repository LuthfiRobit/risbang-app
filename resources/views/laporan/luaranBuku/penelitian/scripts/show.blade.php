<script>
    ...
    $(document).ready(function() {
        ...
        const urlShow = '{{ route('laporan.penelitian.luaran.buku.show', [':id']) }}';
            ...
            DataManager.fetchData(urlShowReplaced)
                .then(function(response) {
                    if (response.success) {
                        ...
                        if (response.data.file_arsip_buku !== null) {
                            const urlPene = "{{ asset('files/arsipBuku/') }}" + "/" + response.data
                                .file_arsip_buku;
                            let ex_file =
                        ...
                        $("#kategori").val(response.data.kategori_buku);
                        $("#isbn").val(response.data.isbn);
                        $("#jumlah").val(response.data.jumlah_halaman);
                        $("#penerbit").val(response.data.penerbit);
                        $("#kota").val(response.data.kota_penerbit);
                        $("#tahun").val(response.data.tahun_terbit);
