...
class LaporanPengabdianController extends Controller
{
    ...
    {
        return view('laporan.pengabdian.index');
    }
    ...
    public function create()
    {
        $data['ta'] = DB::table('tahun_akademik')->select('id_tahun_akademik', 'nama_tahun_akademik')
            ...
            ->get();
        return view('laporan.pengabdian.create', $data);
    }
    ...
    public function store(Request $request)
    {
        ...
        // // if auth dosen
        // if ($this->userRole == 'dosen' && $this->dosenRole == 'dosen') {
        //     $proposalId = $this->dataActiveService->proposalPengabdian($taId, $this->dosenId);
        // }
        ...
        //             $this->dataActiveService->proposalPengabdian($taId, $this->dosenId) :
        //             $this->dataActiveService->proposalPengabdian($taId, $request->id_owner);
        //         break;
        //     case 'admin':
        //         $proposalId = $this->dataActiveService->proposalPengabdian($taId, $request->id_owner);
        //         break;
        ...
        try {
            ...
            DB::rollBack();
            Log::error('Create arsip pengabdian: ' . $th->getMessage());
    ...
    public function edit(string $id)
    {
        $data['ta'] = DB::table('tahun_akademik')->select('id_tahun_akademik', 'nama_tahun_akademik')
            ->orderByDesc('created_at')
            ->get();
        return view('laporan.pengabdian.edit', $data);
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        try {
            ...
            DB::rollBack();
            Log::error('Update arsip pengabdian: ' . $th->getMessage());
            return $this->permissionService->errorResponse('Data gagal diupdate');
        }
    }

    public function listArsipPeng(Request $request)
    {
        $query = DB::table('arsip')
            ->select(
                'arsip.id_arsip',
