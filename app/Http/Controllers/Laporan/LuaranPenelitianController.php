...
class LuaranPenelitianController extends Controller
{
    ...
    {
        return view('laporan.luaranJurnal.penelitian.index');
    }
    ...
    public function createJurnal()
    {
        $data['ta'] = DB::table('tahun_akademik')->select('id_tahun_akademik', 'nama_tahun_akademik')
            ...
            ->get();
        return view('laporan.luaranJurnal.penelitian.create', $data);
    }
    ...
    public function editJurnal(string $id)
    {
        ...
        if ($data) {
            $data['ta'] = DB::table('tahun_akademik')->select('id_tahun_akademik', 'nama_tahun_akademik')
                ->orderByDesc('created_at')
                ->get();
            return view('laporan.luaranJurnal.penelitian.edit', $data);
        } else {
    ...
    public function listJurnal()
    {
        $query = ArsipJurnal::select(
            ...
            ->where('arsip_jurnal.jenis', 'Penelitian')
    ...
    public function storeJurnal(Request $request)
    {
        ...
        try {
            ...
            DB::rollBack();
            Log::error('Create arsip jurnal penelitian: ' . $th->getMessage());
    ...
    public function updateJurnal(Request $request, string $id)
    {
        ...
        try {
            ...
            DB::rollBack();
            Log::error('Update arsip jurnal penelitian: ' . $th->getMessage());
    ...
    {
        return view('laporan.luaranHaki.penelitian.index');
    }
    ...
    public function createHaki()
    {
        $data['ta'] = DB::table('tahun_akademik')->select('id_tahun_akademik', 'nama_tahun_akademik')
            ->orderByDesc('created_at')
            ->get();
        return view('laporan.luaranHaki.penelitian.create', $data);
    }
    ...
    public function editHaki(string $id)
    {
        ...
        if ($data) {
            $data['ta'] = DB::table('tahun_akademik')->select('id_tahun_akademik', 'nama_tahun_akademik')
                ->orderByDesc('created_at')
                ->get();
            return view('laporan.luaranHaki.penelitian.edit', $data);
        } else {
            return redirect()->back()->with('fail', 'Data tidak ditemukan.');
        }
    }
    ...
    public function listHaki()
    {
        $query = ArsipHaki::select(
            ...
            ->leftJoin('prodi', 'prodi.id_prodi', '=', 'dosen.prodi_id')
            ->leftJoin('fakultas', 'fakultas.id_fakultas', '=', 'prodi.fakultas_id')
            ->where('arsip_haki.jenis', 'Penelitian')
    ...
    public function storeHaki(Request $request)
    {
        ...
        try {
            ...
            DB::rollBack();
            Log::error('Create arsip haki penelitian: ' . $th->getMessage());
            return $this->permissionService->errorResponse('data gagal dibuat');
        }
    }
    ...
    public function updateHaki(Request $request, string $id)
    {
        ...
        try {
            ...
            DB::rollBack();
            Log::error('Update arsip haki penelitian: ' . $th->getMessage());
            return $this->permissionService->errorResponse('Data gagal diupdate');
        }
    }
    ...
    {
        return view('laporan.luaranBuku.penelitian.index');
    }
    ...
    public function createBuku()
    {
        $data['ta'] = DB::table('tahun_akademik')->select('id_tahun_akademik', 'nama_tahun_akademik')
            ->orderByDesc('created_at')
            ->get();
        return view('laporan.luaranBuku.penelitian.create', $data);
    }
    ...
    public function editBuku(string $id)
    {
        ...
        if ($data) {
            $data['ta'] = DB::table('tahun_akademik')->select('id_tahun_akademik', 'nama_tahun_akademik')
                ->orderByDesc('created_at')
                ->get();
            return view('laporan.luaranBuku.penelitian.edit', $data);
        } else {
            return redirect()->back()->with('fail', 'Data tidak ditemukan.');
        }
    }
    ...
    public function listBuku()
    {
        $query = ArsipBuku::select(
            ...
            ->leftJoin('prodi', 'prodi.id_prodi', '=', 'dosen.prodi_id')
            ->leftJoin('fakultas', 'fakultas.id_fakultas', '=', 'prodi.fakultas_id')
            ->where('arsip_buku.jenis', 'Penelitian')
    ...
    public function storeBuku(Request $request)
    {
        ...
        try {
            ...
            DB::rollBack();
            Log::error('Create arsip buku penelitian: ' . $th->getMessage());
            return $this->permissionService->errorResponse('data gagal dibuat');
        }
    }
    ...
    public function updateBuku(Request $request, string $id)
    {
        ...
        try {
            ...
            DB::rollBack();
            Log::error('Update arsip buku penelitian: ' . $th->getMessage());
            return $this->permissionService->errorResponse('Data gagal diupdate');
        }
    }
    ...
    {
        return view('laporan.luaranPrototype.penelitian.index');
    }
    ...
    public function createPrototype()
    {
        $data['ta'] = DB::table('tahun_akademik')->select('id_tahun_akademik', 'nama_tahun_akademik')
            ->orderByDesc('created_at')
            ->get();
        return view('laporan.luaranPrototype.penelitian.create', $data);
    }
    ...
    public function editPrototype(string $id)
    {
        ...
        if ($data) {
            $data['ta'] = DB::table('tahun_akademik')->select('id_tahun_akademik', 'nama_tahun_akademik')
                ->orderByDesc('created_at')
                ->get();
            return view('laporan.luaranPrototype.penelitian.edit', $data);
        } else {
            return redirect()->back()->with('fail', 'Data tidak ditemukan.');
        }
    }
    ...
    public function listPrototype()
    {
        $query = ArsipPrototype::select(
            ...
            ->leftJoin('prodi', 'prodi.id_prodi', '=', 'dosen.prodi_id')
            ->leftJoin('fakultas', 'fakultas.id_fakultas', '=', 'prodi.fakultas_id')
            ->where('arsip_prototype.jenis', 'Penelitian')
    ...
    public function storePrototype(Request $request)
    {
        ...
        try {
            ...
            DB::rollBack();
            Log::error('Create arsip prototype penelitian: ' . $th->getMessage());
            return $this->permissionService->errorResponse('data gagal dibuat');
        }
    }
    ...
    public function updatePrototype(Request $request, string $id)
    {
        ...
        try {
            ...
            DB::rollBack();
            Log::error('Update arsip prototype penelitian: ' . $th->getMessage());
            return $this->permissionService->errorResponse('Data gagal diupdate');
        }
    }
    ...
    {
        return view('laporan.luaranProduk.penelitian.index');
    }
    ...
    public function createProduk()
    {
        $data['ta'] = DB::table('tahun_akademik')->select('id_tahun_akademik', 'nama_tahun_akademik')
            ->orderByDesc('created_at')
            ->get();
        return view('laporan.luaranProduk.penelitian.create', $data);
    }
    ...
    public function editProduk(string $id)
    {
        ...
        if ($data) {
            $data['ta'] = DB::table('tahun_akademik')->select('id_tahun_akademik', 'nama_tahun_akademik')
                ->orderByDesc('created_at')
                ->get();
            return view('laporan.luaranProduk.penelitian.edit', $data);
        } else {
            return redirect()->back()->with('fail', 'Data tidak ditemukan.');
        }
    }
    ...
    public function listProduk()
    {
        $query = ArsipProduk::select(
            ...
            ->leftJoin('prodi', 'prodi.id_prodi', '=', 'dosen.prodi_id')
            ->leftJoin('fakultas', 'fakultas.id_fakultas', '=', 'prodi.fakultas_id')
            ->where('arsip_produk.jenis', 'Penelitian')
    ...
    public function storeProduk(Request $request)
    {
        ...
        try {
            ...
            DB::rollBack();
            Log::error('Create arsip produk penelitian: ' . $th->getMessage());
            return $this->permissionService->errorResponse('data gagal dibuat');
        }
    }
    ...
    public function updateProduk(Request $request, string $id)
    {
        ...
        try {
            ...
            DB::rollBack();
            Log::error('Update arsip produk penelitian: ' . $th->getMessage());
            return $this->permissionService->errorResponse('Data gagal diupdate');
        }
    }
